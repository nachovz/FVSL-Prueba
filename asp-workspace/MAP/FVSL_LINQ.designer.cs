...
public partial class FVSL_LINQDataContext : System.Data.Linq.DataContext
{
  ...
  partial void DeleteEMP_Empresa(EMP_Empresa instance);
    ...
    public ISingleResult<dynamicLINQE> mapa_search_empresas_by([Parameter(DbType = "Int")] System.Nullable<int> idPais, [Parameter(DbType = "Int")] System.Nullable<int> idEstado, [Parameter(DbType = "VarChar(8000)")] string nombre, [Parameter(DbType = "Int")] System.Nullable<int> fat, [Parameter(DbType = "Int")] System.Nullable<int> enfoque_geografico)
    {
