...
private function removeOverlay_(marker:IMarker):void {
 ...
 */
private function addMarkerBatch_(marker:IMarker, minZoom:Number, maxZoom:Number):void {
 ...
 */
private function onMarkerMoved_(marker:IMarker, oldLatLng:LatLng, newLatLng:LatLng):void {
 ...
 */
public function addMarker(marker:IMarker, minZoom:Number, opt_maxZoom:Number):void {
  var maxZoom:Number = this.getOptMaxZoom_(opt_maxZoom);
