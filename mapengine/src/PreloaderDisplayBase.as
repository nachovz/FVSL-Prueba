package
{
	...
	public class PreloaderDisplayBase extends Sprite implements IPreloaderDisplay
	{
		...
		virtual public function set preloader(value:Sprite):void
		{
			...
			value.addEventListener(FlexEvent.INIT_PROGRESS, initProgressHandler,false,0,true);
			value.addEventListener(FlexEvent.INIT_COMPLETE, initCompleteHandler,false,0,true);
		}
